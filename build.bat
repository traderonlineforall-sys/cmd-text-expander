...
cl /nologo /std:c++17 /O2 /EHsc /utf-8 /DUNICODE /D_UNICODE src\cmd_v2.cpp publish\app.res /link /SUBSYSTEM:WINDOWS /OUT:publish\cmdTextExpander.exe user32.lib shell32.lib comdlg32.lib gdi32.lib
if errorlevel 1 exit /b 1
